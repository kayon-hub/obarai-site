...
var KB = [
  ...
  },
  {
    ...
    a: 'ORBIT 提供三種方案：\n\n• START（1 帳號，選 3 個模組）\n• PLUS（3 帳號，選 5 個模組）\n• PRO（5 帳號，全模組開通）\n\n所有方案皆含 POS + CRM + AI 基礎，依需求規模客製化報價、年約制，詳細報價請洽業務。',
    lead: true
  },
  {
    keys: ['試用','免費','體驗','try','free','demo'],
    a: 'ORBIT 目前採業務洽談方式安排展示與需求評估，沒有自助試用。歡迎預約展示，我們會依你的產業與規模說明實際功能與報價。',
    lead: true
  },
  {
    keys: ['行業','產業','餐飲','零售','美髮','補習','旅宿','飯店','傳產','適合','industry'],
    a: 'ORBIT 有針對不同行業的推薦套餐：\n\n• 餐飲業 — POS + 預約 + 廚房出單 + QR 點餐\n• 零售業 — POS + 庫存 + 倉儲 + QR 商城\n• 美髮沙龍 — 預約 + LINE + HR 考勤\n• 補教機構 — 預約 + ERP + HR\n• 旅宿業 — 預約 + ERP + 倉儲\n• 傳產/多角化 — PRO 全模組\n\n不確定哪個適合你？告訴我你的行業，我來推薦。'
  },
  {
  ...
  {
    keys: ['estate','豪宅','管家','物業','社區','公設','建案','智慧宅','交屋'],
    a: 'ORBIT ESTATE 豪宅管家模組：\n\n• 住戶服務請求與客服\n• 社區公設線上預約（健身房/會議室/招待所）\n• 包裹到貨通知與代收登記\n• 保固維修工單追蹤\n• 智慧宅控制串接（燈光/空調/門禁）\n\n專為建案與豪宅社區設計，交屋後持續服務住戶。'
  },
  {
